...
class EmployersControllerTest < ActionController::TestCase
  ...
  test "should create employer" do
    assert_difference('Employer.count') do
      post :create, employer: { admission: @employer.admission, avatar: @employer.avatar, dismiss: @employer.dismiss, name: @employer.name, sex: @employer.sex }
    end
  ...
  test "should update employer" do
    patch :update, id: @employer, employer: { admission: @employer.admission, avatar: @employer.avatar, dismiss: @employer.dismiss, name: @employer.name, sex: @employer.sex }
    assert_redirected_to employer_path(assigns(:employer))
  end
